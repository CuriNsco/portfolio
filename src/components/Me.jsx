  ...
  return (
    <section>
        <div className='text-center mt-12 sm:bg-[#ffffff] sm:grid sm:grid-cols-2 sm:text-start sm:justify-items-center'>
            ...
            <a className={`${styles.primaryText} sm:col-start-2 sm:mt-12`} id='about'>About me</a>

            <div className='mx-4 my-8 sm:col-start-1'>
            ...
            <div className=' mx-4 my-12 text-center sm:col-start-2 sm:text-center sm:mt-12 sm:my-4 '>
              <span className='text-xl text-primary leading-loose font-semibold px-4 text-start sm:text-primary sm:text-xl sm:col-start-2 sm:mt-6 sm:leading-loose sm:px-12 sm:pt-12 sm:font-semibold'>
