  ...
  return (
    <section>
        <div className='bg-[#f8f7f1] mt-12 sm:grid sm:grid-cols-3 sm:mt-12'>
            <div className='bg-red-200 flex flex-col text-center mx-12 py-12  sm:flex sm:flex-col sm:text-start sm:items-start sm:col-span-2 sm:ml-12'>
            ...
            <div className='sm:col-start-3 sm:row-start-1 sm:row-span-2 sm:mt-20 sm:ml-12'>
