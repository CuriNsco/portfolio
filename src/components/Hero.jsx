    ...
    <section>
        <div className={`grid grid-cols-3 grid-rows-1 bg-[#f8f7f1] sm:flex sm:bg-[#f8f7f1] sm:grid sm:grid-cols-3`}>
            ...
            <div className={` ${styles.animationRight} flex flex-col items-center text-center col-start-1 row-start-3 col-span-3 sm:col-start-3 sm:row-start-1 sm:text-center sm:items-center sm:flex sm:flex-col`}>
                ...
                <span className='text-2xl text-[#0d2f3f] font-roboto font-semibold px-8 py-8 sm:text-2xl sm:font-roboto sm:px-8 sm:mt-20 sm:text-[#0d2f3f] sm:font-semibold'>I design beautiful simple things, And I love what I do</span>

                <span className='text-2xl text-[#0d2f3f] font-roboto font-semibold py-8 sm:text-xl sm:font-roboto sm:text-[#0d2f3f] sm:font-semibold'>FULL STACK DEVELOPER <br/> CERTIFIED</span>
